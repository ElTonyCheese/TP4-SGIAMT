...
namespace SGIAMT.Controllers
{
    public class EUsuariosController : Controller
    {
        ...
        {
            var bD_SGIAMTContext = _context.EUsuario.Include(e => e.FkIc).Include(e => e.FkIdiCodNavigation).Include(e => e.FkItuTipoUsuarioNavigation);
        ...
        //        .Include(e => e.FkIc)
        //        .Include(e => e.FkIdiCodNavigation)
        //        .Include(e => e.FkItuTipoUsuarioNavigation)
        ...
        {
            ViewData["FkIcId"] = new SelectList(_context.ECategoría, "PkIcId", "VcNombreCat");
            ViewData["FkIdiCod"] = new SelectList(_context.EDistrito, "PkIdiCod", "VdiNombreDis");
            ViewData["FkItuTipoUsuario"] = new SelectList(_context.ETipoUsuario, "PkItuTipoUsuario", "VtuNombreTipoUsuario");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("PkIuDni,VuNombre,VuApaterno,VuAmaterno,VuCelular,VuCorreo,VuDireccion,DuFechaNacimiento,VuSexo,VuContraseña,VuEstado,VuHorario,FkItuTipoUsuario,FkIcId,FkIdiCod")] EUsuario eUsuario)
        {
            ...
            ViewData["FkIcId"] = new SelectList(_context.ECategoría, "PkIcId", "VcNombreCat", eUsuario.FkIcId);
            ViewData["FkIdiCod"] = new SelectList(_context.EDistrito, "PkIdiCod", "VdiNombreDis", eUsuario.FkIdiCod);
            ViewData["FkItuTipoUsuario"] = new SelectList(_context.ETipoUsuario, "PkItuTipoUsuario", "VtuNombreTipoUsuario", eUsuario.FkItuTipoUsuario);
            return View(eUsuario);
        }
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(int id, [Bind("PkIuDni,VuNombre,VuApaterno,VuAmaterno,VuCelular,VuCorreo,VuDireccion,DuFechaNacimiento,VuSexo,VuContraseña,VuEstado,VuHorario,FkItuTipoUsuario,FkIcId,FkIdiCod")] EUsuario eUsuario)
        //{

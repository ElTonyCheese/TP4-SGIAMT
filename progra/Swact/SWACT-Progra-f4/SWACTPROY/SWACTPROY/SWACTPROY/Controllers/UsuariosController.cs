...
namespace SWACTPROY.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<string> EditUsuario(string id, string userName, string email,
          int phoneNumber, int accessFailedCount, string concurrencyStamp, bool emailConfirmed,
        ...
        public async Task<String> CreateUsuario(string email,
            int phoneNumber,string nombre,string apellidopaterno,string apellidomaterno, int tipodocumento,int documento, string direccion, string passwordHash,

...
function mostrarUsuario(response) {
    ...
    $.each(items, function (index, val) {
        ...
        $('input[name=PhoneNumber]').val(val.telefono);
        ...
        $("#dPhoneNumber").text(val.telefono);
        $("#dRole").text(val.role);
...
function crearUsuario(action) {
    ...
    apellidopaterno = $('input[name=ApellidoPaternoNuevo]')[0].value;
    apellidomaterno = $('input[name=ApellidoMaternoNuevo]')[0].value;
